...
public class LinkedStack<T> {
    ...
    public void push(T data) {
        if (data == null) {
            throw new java.lang.IllegalArgumentException("Cannot insert null data into the stack");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Cannot peek into empty stacks");
        }
        return head.getData();
    }
